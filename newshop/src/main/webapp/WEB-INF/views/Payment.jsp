...
<h2>Pay Here......</h2>
   ...
   <springForm:input id="cardtype" path="pymtcardtype"  required="true" />
    ...
    <option value="MASTERCARD">MasterCard</option>
		...
		<ol>
			<li>
                ...
                <springForm:input id="cardnumber" path="pymtcardnumber" name="cardnumber" type="number" required="true" />
            </li>
            <li>
            ...
            <li>
                ...
                <springForm:input id="namecard" path="pymtnameoncard" name="namecard" type="text" placeholder="Exact namne as on the card" required="true" />
            </li>
        </ol>
    </fieldset>
    <fieldset>
        <button type="submit">PAY!</button></a>
    </fieldset>
</springForm:form>
</div>
</body>
